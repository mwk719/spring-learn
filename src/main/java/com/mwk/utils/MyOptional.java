...
public final class MyOptional {
	 ...
	 * @return
	 */
	public static <T> Object getValueByField(Object source, String filed, final Class<T> vClass) {
		Objects.requireNonNull(filed);
		String[] filedNames = filed.split("\\.");
		Object oldTemp;
		if (filedNames.length == 1) {
			return ReflectionUtil.invokeGetterMethodNoThrowException(source, filed);
		}
